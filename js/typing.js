...
// ================= PRODUCT DEMO REQUEST VIA WHATSAPP =================
const productCards = document.querySelectorAll('.product-card');

productCards.forEach(card => {
  card.addEventListener('click', () => {
    const productName = card.getAttribute('data-product');
    const message = `Hello, I would like to request a demo for ${productName}.`;
    const phone = "263772430466"; // Replace with your WhatsApp number including country code, e.g., 263777123456
